...
pickle.dump(X_test, open('pkl_lea/complet2_X_test.pkl', 'wb'))
pickle.dump(y_train, open('pkl_lea/complet2_y_train.pkl', 'wb'))
pickle.dump(y_test, open('pkl_lea/complet2_y_test.pkl', 'wb'))


X_train = pickle.load(open('pkl_lea/complet2_X_train.pkl', 'rb'))
X_test = pickle.load(open('pkl_lea/complet2_X_test.pkl', 'rb'))
y_train = pickle.load(open('pkl_lea/complet2_y_train.pkl', 'rb'))
y_test = pickle.load(open('pkl_lea/complet2_y_test.pkl', 'rb'))
...
# On enregistre la séparation
pickle.dump(X_train, open('pkl_lea/completchamp_X_train.pkl', 'wb'))
pickle.dump(X_test, open('pkl_lea/completchamp_X_test.pkl', 'wb'))
pickle.dump(y_train, open('pkl_lea/completchamp_y_train.pkl', 'wb'))
pickle.dump(y_test, open('pkl_lea/completchamp_y_test.pkl', 'wb'))


X_train = pickle.load(open('pkl_lea/completchamp_X_train.pkl', 'rb'))
X_test = pickle.load(open('pkl_lea/completchamp_X_test.pkl', 'rb'))
y_train = pickle.load(open('pkl_lea/completchamp_y_train.pkl', 'rb'))
y_test = pickle.load(open('pkl_lea/completchamp_y_test.pkl', 'rb'))
