...
# best = bestParamsplot2(X_train, X_test, y_train, y_test, range(2, 50), range(2, 50)) # donne samples = 12 et depth = 11
# On fait l'arbre
...
print('La precision est de ', acc*100, ' %.')
...
# # On calcule les meilleurs paramètres
# best = bestParamsplot2(X_train, X_test, y_train, y_test, range(2, 30), range(2, 30)) # donne samples = 12 et depth = 11
# # # On fait l'arbre
