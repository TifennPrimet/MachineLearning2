...
# On sépare le jeu de données
X2, y2 = prepare_donnee(getStat_red_blue, ('top', ('hp','armor','attack')))
...
# Validation du modèle
scores = cross_validation(X2, y2, 10)
print('La liste des scores est donnée par ', scores)
print('La moyenne des scores est de ', np.mean(scores))
print('L\'écart type des scores est de ', np.std(scores))
...
# On sépare le jeu de données
X3, y3 = prepare_donnee(getStat_red_blue, ('top', ('hp','armor','attack')), ('jungle', ('attack',)), ('mid',('magic',)),('adc',('attack','attackspeed')), ('support',('hp',)))
# X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
# On enregistre la séparation
...
# Validation du modèle
scores2 = cross_validation(X3, y3, 10)
print('La liste des scores est donnée par ', scores2)
print('La moyenne des scores est de ', np.mean(scores2))
print('L\'écart type des scores est de ', np.std(scores2))
